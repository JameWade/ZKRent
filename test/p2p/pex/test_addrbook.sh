...
docker cp "local_testnet_$ID:/go/src/github.com/ChengtayChain/ChengtayChain/test/p2p/data/mach0/config/addrbook.json" "/tmp/addrbook.json"
set +e #CIRCLE
...
docker cp "/tmp/addrbook.json" "local_testnet_$ID:/go/src/github.com/ChengtayChain/ChengtayChain/test/p2p/data/mach0/config/addrbook.json"
